...
<t:layout title="Yêu cầu rút tiền" active="wallet-withdrawals">
    <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between mb-3">
        <div>
            ...
            <div class="text-muted small">Danh sách yêu cầu chờ duyệt.</div>
        </div>
    </div>
    ...
    <form method="post" action="${pageContext.request.contextPath}/accounting/wallet-withdrawals">
            ...
            <table class="table table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    <c:if test="${empty rows}">
                        <tr>
                            <td colspan="5" class="text-center text-muted">Không có yêu cầu nào.</td>
                        </tr>
                    </c:if>
                </tbody>
            </table>
