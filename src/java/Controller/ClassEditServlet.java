...
public class ClassEditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            CenterClass c = id > 0 ? classDAO.findById(id) : null;
            if (c == null) {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            int id = parseInt(req.getParameter("classId"), -1);
            CenterClass existing = id > 0 ? classDAO.findById(id) : null;
            if (existing == null) {
                resp.sendRedirect(req.getContextPath() + "/admin/classes");
                return;
            }
            ...
            if (byCode != null && byCode.getClassId() != c.getClassId()) {
