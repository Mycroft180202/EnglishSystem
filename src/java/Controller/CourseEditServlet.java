...
public class CourseEditServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            String[] range = parseLevelRange(c.getLevel());
            req.setAttribute("levelFrom", range == null ? "" : range[0]);
            req.setAttribute("levelTo", range == null ? "" : range[1]);
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            int id = parseInt(req.getParameter("courseId"), -1);
            Course existing = id > 0 ? courseDAO.findById(id) : null;
            if (existing == null) {
                resp.sendRedirect(req.getContextPath() + "/admin/courses");
                return;
            }
            ...
            if (c.getLevel() == null) {
                ...
                if (levelFrom == null && levelTo == null && existing.getLevel() != null) {
                    c.setLevel(existing.getLevel());
                }
            }
            ...
            Course byCode = courseDAO.findByCode(c.getCourseCode());
            if (byCode != null && byCode.getCourseId() != c.getCourseId()) {
    ...
    private static String validate(Course c) {
