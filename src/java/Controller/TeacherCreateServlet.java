...
@WebServlet("/admin/teachers/create")
public class TeacherCreateServlet extends HttpServlet {
    private final TeacherDAO teacherDAO = new TeacherDAO();
    private static final String TOKEN_KEY = "teacherCreateToken";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            teacherDAO.create(t);
            Flash.success(req, "Tạo giáo viên thành công.");
            resp.sendRedirect(req.getContextPath() + "/admin/teachers");
        } catch (Exception ex) {
    ...
    private static Teacher read(HttpServletRequest req) {
